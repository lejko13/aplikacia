...
const inteligent = useRef(null)
 ...
 const navigate = useNavigate();
  ...
  const { pocetOblubene, setPocetOblubene, filter, setFilter,owerlap,seTeraz,teraz ,setInfo,scrollToRef,informacie,hodnotenie,majitel,otazky,
     vidim,setVidim,text2,druha,tretia,akotofunugje,klikanec,objekt1,random,setRandom,pocitam2,setPocitam2
...
//  setPocitam(apartman?.cena)

// useEffect(() => {
//   if(apartman) setPocitam(apartman.cena);
// }, []);
