...
const Lenkosik = ({ klikamamma,nazov, klik22,location, hodnotenie, children,krajina, fotky = [],style, kontrola,prepinam ,apartman,setOtvorenie,setFarba,setQuery,otvorenie,zmaz,zmaz2}) => {
 ...
 <>
      ...
      >
        <div className='fotkaNahladSwiper'>
            ...
            <Swiper className='swiperecekalenoo'
