...
const Komponenta = ({nazov,stilicekostko,textikona,kvak,text,children,doleziet,linktext,kliknutie,stylececek,kluc,unikat,desing,dizajnicek,zobrazenie}) => {
...
const text1 = useRef(null)
  return (
    <div className='Komponenta' style={stilicekostko}>
