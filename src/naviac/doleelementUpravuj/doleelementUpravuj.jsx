...
import { Buttondatum } from '../../naviac/buttondatum/buttondatum'


import Ceny from '../ceny/ceny'
const DoleelementUpravuj = ({pocitam,setPocitam,zobrazenie,kokokopok,skryto,apartman,pocitam2,setPocitam2,clovek,ponuka}) => {
...
// console.log(pocitam);
 ...
 const { pocetOblubene, setPocetOblubene, filter, setFilter,owerlap,seTeraz,teraz ,setInfo,scrollToRef,
             ...
             setPresun,presun,otocene, setOtocene,automatika,
               ...
               prvydatum,setPrvydatum,druhydatum,setDruhydatum,rozdiel,setRozdiel,setZobrazovanie,ano,setAno,setOtvorenie
...
const [prichod, setPrichod] = useState(null);
...
const[funkcianaukaldanie1,setUkladanie1] =useState(null)
const[funkcianaukaldanie2,setUkladanie2] =useState(null)
const[prepocet,setPrepocet] = useState(null)

const[pocetzekolko,setPocetzekolko] = useState(2)

const aktualizujem = () => {
    // setPrichod(funkcianaukaldanie1)
    // setOdchod(funkcianaukaldanie2)
...
setKontrolaText("jetuzrezervacii")
  ...
  aktualizujem()
    setPresun(prev => [...prev, { dospeli, deti,apartman,pocitam,hostia ,batolata,clovek,prichod,odchod,prepocet,pocetzekolko}]);
    navigate('/Rezervacie');
    // setPocitam2(pocitam)
...
setBatolata(0)
  ...
  return (
     ...
     <div className='komponnetntet'>
                  ...
                  flexDirection: "column" ,
                   ...
                   <p style={{fontSize:"var( --font-size-base4)",color:"var(--farba-cierna)"}}>Zriedkavo voľné! </p>
                      ...
                      <span style={{fontSize:"var( --font-size-small)",color:"var(--farba-cierna)"}}> Toto ubytovanie je zvyčajne rezervované.</span>
                      </div>
                  </div>
                  ...
                  <div className='doleElemenet'>
                    ...
                    onClick={() => {
                      ...
                      >€ {prepocet ? prepocet.toFixed(2) : pocitam.toFixed(2)}

                      {/* {pocitam} */}
                      </span>
                      
                      <span  style={{fontSize:"var( --font-size-base2)",color:"var(--farba-sivaText)"}}>za {pocetzekolko} noci</span>
                    ...
                    <div className='vyber'>
                        ...
                        <div className='horepocet'>
                            <div className='horehorrehroe'>
                                  ...
                                  <Buttondatum
                                  props = {() => aktualizujem()}
                                  setUkladanie1 = {setUkladanie1}
                                  setUkladanie2 = {setUkladanie2}

                                  setPrichod= {setPrichod}
                                  setOdchod = {setOdchod}
                                  setPrepocet = {setPrepocet}
                                  pocitam = {pocitam}
                                  setPocetzekolko = {setPocetzekolko}
                                  ></Buttondatum>
    ...
    vymazat();
    setZobrazovanie("")
    console.log("kokokokokokokokvhsdhvbdhfbvhjdfvbjdbvjhdbdjhfbv")
...
export default DoleelementUpravuj
