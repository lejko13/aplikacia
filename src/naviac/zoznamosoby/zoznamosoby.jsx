...
export const ludia = [
  {
    ...
    klientPriezvisko: "Fudaly",
    omne: "Mám rád hudbu, dobré jedlo a výlety po meste. Vo voľnom čase si rád oddýchnem s priateľmi alebo pri filme",
    klientMesto: "Košice, Slovensko",
    klientDatum: "5.10 2025",
    email:"milkas@gamil.com",
    kareke:"Super hostiteľ",
...
odpoved5: "Parkovanie je možné na verejných miestach pred budovou."
...

  {
    id: "2",
     ...
     FOTKAMAJITAL: "/muz.webp",
    klientMeno: "Lea",
    klientPriezvisko: "Marketova",
     omne: "Som Lea, mám rada dobrú hudbu, smiech a keď je čas, rada objavujem nové miesta v meste. Bratislava je môj domov a vždy hľadám niečo zaujímavé, čo stojí za to.",
    klientMesto: "Levice, Slovensko",
...

  {
    ...
    klientPriezvisko: "Novak",
        omne: "Som Marek, mám rád šport, dobré jedlo a chill s kamarátmi. Bratislava je môj domov a vždy hľadám niečo zaujímavé, čo sa dá zažiť.",
      email:"novak@gamil.com",
    klientMesto: "Nitra, Slovensko",
...
,
...

  {
    ...
    omne: "Ahoj, som Sofia. Rada si oddýchnem pri filme, zabavím sa s kamoškami a niekedy si len tak posedím pri dobrej káve. Život je príliš krátky na nudu.",
    klientMesto: "Trnava, Slovensko",
...
konverzacia: [
...

  {
    ...
    aktivny:"ano",
    klientMeno: "Tomas",
     omne: "Som Tomáš, mám rád dobrú hudbu, šport a chvíle s kamarátmi. Rád skúšam nové veci a vždy hľadám niečo zaujímavé, čo sa dá zažiť.",
      email:"tomaskohruby@gamil.com",
    klientPriezvisko: "Hruby",
    klientMesto: "Senica, Slovensko",
...
,
...

  {
    ...
    klientPriezvisko: "Mikulasova",
    
    omne:"Ahoj, som Nina. Milujem spontánne dobrodružstvá, smiech a dobrú kávu. Niekedy sa len tak túlam mestom a hľadám nové miesta, kde sa dá zabaviť",
    klientMesto: "Poprad, Slovensko",
    klientDatum: "13.2 2023",
    klientAkoDlho: "Pobyt trval štyri dni",
       klientFotky: "/zena4.webp",
...
,
...

  {
    ...
    aktivny:"ano",
    klientMeno: "Filip",
     omne:"Som Filip. Rád skúšam nové veci, chillujem s kamarátmi a niekedy sa úplne stratím v dobrej hudbe alebo filme. Život je príliš krátky na nudu.",
    klientPriezvisko: "Sedlak",
    klientMesto: "Presov, Slovensko",
  ...
  
  {
    ...
    ide:"H",
     ...
     FOTKAMAJITAL:  "/muz.webp",
        aktivny:"nie",
    klientMeno: "Laura",
    omne:"Káva, knihy a dlhé prechádzky mestom – to sú moje malé rituály. Milujem, keď deň prináša niečo nové a neočakávané.",
    klientPriezvisko: "Vesela",
    klientMesto: "Kezmarok, Slovensko",
    klientDatum: "12.10 2025",
    klientAkoDlho: "Pobyt trval tri dni",
    klientFotky: "/zena3.webp",
...
// 
  {
    ...
    ide:"I",
     ...
     FOTKAMAJITAL:  "/muz.webp",
        aktivny:"nie",
    klientMeno: "Peter",
      omne:"Dobré jedlo, hudba a spontánne nápady robia moje dni zaujímavými. Vždy hľadám nové veci, ktoré stoja za to zažiť.",
    klientPriezvisko: "Cerny",
    klientMesto: "Zilina, Taliansko",
...
odpovede: [
...

  {
    ...
    klientMeno: "Ema",
    omne:"Dlhé prechádzky, smiech s kamarátmi a malé objavy každý deň – to ma drží v pohode a nabíja energiou.",
    klientPriezvisko: "Horvathova",
    klientMesto: "Martin, Slovensko",
    klientDatum: "24.6 2023",
    klientAkoDlho: "Pobyt trval päť nocí",
klientFotky: "/zena2.webp",
...
odpovede: [
...

  {
    ...
    aktivny:"ano",
    klientMeno: "Adam",
    omne:"Výzvy ma bavia, dobrá hudba ma nabíja a spontánne nápady robia dni zábavnejšími. Nikdy nie je nuda.",
    klientPriezvisko: "Kral",
    klientMesto: "Ružomberok, Slovenko",
    klientDatum:"13.12 2024",
    klientAkoDlho: "Pobyt trval dva dni",
    klientFotky: "/muz7.webp",
...
odpovede: [
...

  {
    ...
    aktivny:"nie",
    klientMeno: "Zuzana",
    omne:"Malé radosti, smiech a objavovanie nových miest robia každý deň zaujímavým. Život je lepší, keď sa dá prežiť naplno.",
    klientPriezvisko: "Polakova",
    klientMesto: "Banska Bystrica, Slovensko",
    klientDatum: "19.2 2023",
    klientAkoDlho: "Pobyt trval štyri dni",
   klientFotky: "/zena6.jpg",
    klientHodnotenieVlaste: "4.70",
   konverzacia: [
...
odpovede: [
...

  {
    ...
    klientMeno: "Natália",
    omne:"Slnečné dni, dobrá hudba a spontánne dobrodružstvá robia moje dni veselšími. Každý deň je šanca na niečo nové.",
    klientPriezvisko: "Molnarova",
    klientMesto: "Trebišov, Slovensko",
...
odpovede: [
...

  {
    ...
    ide:"N",
      FOTKAMAJITAL:  "/muz.webp",
    klientMeno: "Tomas",
    omne:"Rád objavujem nové veci, smiech a dobrá spoločnosť ma vždy dostanú do pohody. Každý deň je príležitosť na malé dobrodružstvo.",
    klientPriezvisko: "Urban",
    klientMesto: "Trečin, Slovenko",
...
odpovede: [
  ...
  
  {
    ...
    aktivny:"ano",
     FOTKAMAJITAL:  "/muz.webp",
    klientMeno: "Elena",
    omne:"V jednoduchosti je krása – káva, dobrá kniha a prechádzky mestom ma vždy nabijú energiou a pohľadom na svet s úsmevom.",
    klientPriezvisko: "Kovacova",
    klientMesto: "Zvolen, Slovensko",
...
export const majitel = [ {
    ...
    komplexnytext:"Ahoj! Volám sa Tomáš a som vášnivý cestovateľ, ktorý rád objavuje nové miesta a kultúry. Okrem cestovania mám veľký záujem o fotografovanie, hudbu a varenie – vždy hľadám spôsoby, ako spojiť tieto vášne s každodenným životom. Milujem stretávanie nových ľudí, výmeny skúseností a učenie sa nových vecí, či už ide o jazyk, remeslo alebo technológiu. Na tomto profile zdieľam svoje zážitky, tipy na cestovanie a odporúčania, ako si spríjemniť voľný čas. Verím, že každý deň je príležitosťou objavovať a rásť, a rád sa o svoje skúsenosti delím s komunitou.",


    vyhoda1: "Skúsený a spoľahlivý",

    vyhoda2: "Komunikatívny – rýchlo reaguje a je otvorený diskusii.",

    vyhoda3: "Precízny a dôsledný – venuje pozornosť detailom.",

    vyhoda4: "Kreatívny – prichádza s inovatívnymi nápadmi a riešeniami.",
    ...
    klientHodnotenieVlaste: "4.21",
     ...
     hodnotim:5,
       ...
       email:"luna.storm92@outlook.com",
...

  {
    ...
    // klientFotky: "/muz8.avif",
    // klientHodnotenieVlaste: "4.21",
       email:"violet.skyline23@yahoo.com",
    klientHodnotenie:
      "Apartmán bol veľmi čistý a pohodlný, lokalita skvelá na prechádzky po centre Paríža.",
  },
...

  {
    ...
    // klientPriezvisko: "Kovac",
     hodnotim:3,
    email:"aurora.mist77@protonmail.com",
    // klientMesto: "Praha, Česká republika",
    klientDatum: "23.5 2012",
    // klientAkoDlho: "Pobyt trval päť nocí",
    // klientFotky: "/muz5.jpg",
    // klientHodnotenieVlaste: "3.52",
    klientHodnotenie:
      "Pekný výhľad na more, pokojná ulica a všetko po ruke.",
  },

  {
    ...
    klientMeno: "Nina",
    klientPriezvisko: "Mikulasova",
    klientMesto: "Michalovce, Slovensko",
    klientDatum: "13.2 2023",
    klientAkoDlho: "Pobyt trval štyri dni",
       klientFotky: "/zena4.webp",
    klientHodnotenieVlaste: "4.70",
    ...
    // klientMeno: "Lucia",
    // klientPriezvisko: "Horvathova",
    email:"blaze.river45@hotmail.com",
  ...
  recencie:[
    ...
    klientDatum: "5.10 2025",
    klientAkoDlho: "Pobyt trval jednu noc",
    klientFotky: "/muz.webp",
    klientHodnotenieVlaste: "4.54",
    klientHodnotenie:
      "Tiché prostredie, dobrá dostupnosť a rýchle odpovede od hostiteľa.",
    ...
    klientHodnotenieVlaste: "5.00",
    klientHodnotenie:
      "Ubytovanie splnilo očakávania, hostiteľ bol veľmi ochotný.",
  },
    ...
    klientAkoDlho: "Pobyt trval jednu noc",
     klientFotky: "/muz.webp",
    klientHodnotenieVlaste: "3.24",
    klientHodnotenie:
      "Príjemný pobyt, všetko prebehlo hladko. Lokalita bola veľkým plusom.",
  },
  ...
  klientFotky: "/muz.webp",
    klientHodnotenieVlaste: "4.54",
    klientHodnotenie:"Skvelá lokalita rýchla komunikácia s hostiteľom a príjemný pobyt. Určite odporúčam a rád sa vrátim"
  },
    ...
    klientHodnotenieVlaste: "5.00",
    klientHodnotenie:
    "Výborná poloha, čisté ubytovanie a bezproblémová komunikácia. Odporúčam"
  },
  ],
  ...
  fotky: ["/8.webp", "/8.webp","/8.webp","/8.webp"],bazen:"ano",autor:"J",
   },
...
fotky: ["/15.webp", "/15.webp","/15.webp","/15.webp"],autor:"J",
   },
...
fotky: ["/1.webp", "/1.webp","/1.webp","/1.webp"],ideal:"predvoch",
  ...
  { id: "6NSA", krajina: "Slovensko", kraj: "Nitriansky", location: "Šaľa", name: "Apartmán Lesný", hodnotenie: "4,86", cena: 10,
     fotky: ["/2.webp", "/2.webp","/2.webp","/2.webp"],autor:"J",
  },
]
,
byvanieotazky:[
  {
    otazka1:"Je v byte dostatok úložného priestoru?",
    odpoved1:"Áno, sú tu vstavané skrine.",

    otazka2:"Aké sú mesačné náklady na bývanie?",
    odpoved2:"Približne 160 €...",

    otazka3:"Je v blízkosti dostupná vybavenosť?",
    odpoved3:"Áno, do 5 minút su potraviny...",

    otazka4:"Sú v byte povolené domáce zvieratá?",
    odpoved4:"Áno, po dohode s majiteľom...",

    otazka5:"Je k dispozícii parkovacie miesto?",
    odpoved5:"Verejné parkovanie je možné...",
  }
