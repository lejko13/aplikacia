...
// }, [pocetOblubene]);
  ...
  //   if (existuje) {
  //     setMala("Odstránené"); // stav pre UI, že bol odstránený
  //     return stary.filter(e => e.id !== prev.id); // odstráni objekt
  //   } else {
  //     setMala("Pridané"); // stav pre UI, že bol pridaný
  //     return [...stary, prev]; // pridá objekt
  //   }
  // });
  setOblubene(stary => {
    const existuje = stary.some(e => e.id === prev.id)
