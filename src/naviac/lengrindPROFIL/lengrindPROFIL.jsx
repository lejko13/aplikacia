...
const LengrindPROFIL = ({cislo1,cislo2,popisek,prezvisko32,meno43,fotka,celok,farba,setFarba,ulozit,setUlozit}) => {
 ...
 const { suborOpen,setSuborOpen,obsahOpen,setObsahOpen,subor,setSubor,nazovSuboru,setNazovSuboru,unikattne,setUnikatne,meno,
  ...
  const isMobile = useMediaQuery({ minWidth: 451 });
...
{ulozit === "upravit" && <div className='tutojehoreee'>
  {isMobile1 &&  <Ukazka
        klllppmi = {{ justifyContent:"start", background: "var(--farba-biela)",margin:"0px 0px 0px 0px",borderTop:"none",borderBottom:"none"}}
        fotka = {fotka}
        meno = {meno43}
  ...
  {isMobile  &&  <Ukazka
        klllppmi = {{  background: "var(--farba-biela)",margin:"0px 0px 0px 0px",borderTop:"none",borderBottom:"none"}}
        fotka = {fotka}
        meno = {meno43}
        priezvisko = {prezvisko32}
        popisek = {popisek}
