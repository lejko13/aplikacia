...
const Nahlad2 = ({ schovatjmozno,klikamkoko,nazov,klikkam, location, hodnotenie, krajina, fotky = [],style, kontrola,prepinam ,apartman,setOtvorenie,setFarba,setQuery,otvorenie,zmaz,zmaz2,ikonaaaaa}) => {
  ...
  setFilter(false)
          ...
          >
              ...
              <span style={zmaz} className='lentakkkomokoonjnjhnh'    onClick={() => {klik()}}>{location}</span>


            <div className='zobrazujjemmee9' style={{display:"flex",gap:"5px",alignItems:"center"}}>
              <div style={schovatjmozno}>
              <span style={{fontSize:"12px",color:"gold"}}> <i class='bx bxs-star'></i></span>
              </div>
