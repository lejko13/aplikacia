...
const Nakup2 = ({pocetnoci,odchod,prichod,zdielamelen,mozno,hlas,pripocitavamBATOLATA,onClick54,odpocitavamBATOLATA,pripocitavamDETI,odpocitavamDETI,odpocitavamDOSPELE,datutjem,pridanie,jeden,dva,tri,nazovnazov,odsranenei,children,name,fotky,hodnotenie,location,penezi,hostia,pripocotamvamDOSPELI,menoDALSI,priezviskomenoDALSI,fotkamenoDALSI,popisekmenoDALSI}) => {
...
{doplnok3 && 
<div className='obalnaswiperrrnovymobil'>
  <Nakupswiper
  fotky = {fotky}
  onClick = {() => onClick54()}
  tu = { <div style={{display:"flex",gap:"10px"}}>
          <Ukazovatelko
        onClick = {zdielamelen}
        style = {{color:"var(--farba-cierna)",fontSize:"15px",backgroundColor:"var(--farba-main2)"}}
...
{doplnok2 &&  <Lenkosik
      ...
      {/*  */}
      <div className='celkokokokolloksdrzak4434'>
        <div style={{width:"100%",display:"flex",justifyContent:"space-between"}}>
           <div>
          <span className='TEXTICEKNEAOVICEK2' style={{fontSize:"var(-font-size-base100)"}} onClick={onClick54}>{nazovnazov}</span>
            {/* <p className='textpodhlavnuym32323'>         {jeden} /         {dva} /         {tri}</p>
         */}
      ...
      <div className='textceklencos2'>
                    ...
                    onClick={() => {
                      setPenaze(prev => !prev)}}
                      style={{fontSize:"var(--font-size-base5)",color:"var(--farba-cierna)",textDecoration:"underline",cursor:"pointer"}}
