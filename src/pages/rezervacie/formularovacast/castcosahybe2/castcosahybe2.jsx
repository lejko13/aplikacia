...
import Hybes2 from '../hybes2/hybes2'
...
const Castcosahybe2 = () => {
  ...
  const {datum, setDatum, rok, setRok,otvorenie, setOtvorenie,krajina, setKrajina,otovreniedatumu, setOtovreniedatumu,otovrenieROKU, setOtovrenieROKU,aktualnyROK, setaktualnyROK,aktuakyMESIAC,setAktualnyMESIAC,mnesic,setMnesic,alternativa,setAlternativa,alternativa2,setAlternativa2} = useDatePicker()
...
console.log(pole);
          ...
          <div className="halvnyobsah32">
            ...
            <div className="ovaldanienicien">
              <div className="textovacastikokok">
               ...
               {vidimne && 
               <>
                 <span className = "lentexnatext" 
                 onClick={() => { setOtovreniedatumu(prev => !prev),setAlternativa(prev => !prev)}}>Mesiac</span>

                <span className = "lentexnatext"
                 onClick={() => {setOtovrenieROKU(prev => !prev),setAlternativa2(prev => !prev)}}>Rok</span>
                </>
  ...
  backgroundColor: cisielko === item.cislo || cisielkoHOVER === item.cislo ? "var(--farba-main)" : "var(--farba-main2)"
              ...
              >{item.kluc}</Taktotomabyt>
               ...
               {/* ibuhiuybvebvyubhdfgnbjkdhbjdbhjdbhjdsbvfhjasdgvhsvhdg */}
               ...
               animate={{
              height: "fit-content",
              backgroundColor:alternativa ? "pink" : "pink",
             }}>
                
               <motion.div    
               className='ukazkaako' 
                 initial={{ height: "0px", backgroundColor: "pink" }}
               animate={{
          height: alternativa ? "130px" : "0px",
          backgroundColor: alternativa ? "var(--farba-biela)" : "var(--farba-biela)",
                }}>
  ...
  backgroundColor: farba === item.id
    ...
    : "var(--farba-main2)"
              ...
              >{item.kluc}</Taktotomabyt>
                ...
                <motion.div    
               className='ukazkaako' 
                 initial={{ height: "0px", backgroundColor: "var(--farba-biela)" }}
               animate={{
          height: alternativa2 ? "100px" : "0px",
          backgroundColor: alternativa2 ? "var(--farba-biela)" : "var(--farba-biela)",
                }}>
      ...
      style={{ 
    color: cisielko === item.cislo
      ? "white"
      : "var(--farba-cierna)",

    backgroundColor: cisielko === item.cislo
      ? "var(--farba-main)"
      : "var(--farba-main2)"
  }}
